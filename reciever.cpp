...
// Função para testar operações de leitura e escrita de arquivo
...
// Estrutura de exemplo para receber dados
...
// Função de retorno de chamada executada quando dados são recebidos
...
void setup() {
  ...
  // Uma vez que o ESPNow foi inicializado com sucesso, registramos o callback de recebimento
